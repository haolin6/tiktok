...
- `docs/requirements_and_architecture.md`：需求与架构规划
- `docs/development_schedule.md`：节点排期
- `docs/websocket_event_protocol.md`：WebSocket 事件协议
- `docs/concurrency_demo.md`：并发演示说明
- `docs/2026-06-10-demo-script.md`：10-15 分钟完整演示脚本
- `docs/2026-06-09-three-minute-demo-video-script.md`：3 分钟演示视频脚本
- `docs/2026-06-10-technical-defense.md`：技术答辩说明
- `docs/2026-06-10-final-acceptance-checklist.md`：最终验收清单
- `docs/2026-06-10-ai-usage-and-review.md`：AI 使用说明和人工把控记录
...
这些能力可以作为后续扩展方案说明，不应在当前演示中冒充已完成。

## 安全说明

- `.env` 存放本地真实配置，不应提交。
- `.env.example` 只保留占位字段。
- 不要把真实 API Key、云服务账号、数据库密码或个人 token 写入仓库。
